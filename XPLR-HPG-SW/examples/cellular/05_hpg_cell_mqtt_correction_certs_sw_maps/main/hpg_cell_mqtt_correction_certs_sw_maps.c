...
/**
 * Send location to bluetooth device
 */
#define APP_BT_LOCATION_INTERVAL 5
...
static appLog_t appLogCfg = {
    .logOptions.allLogOpts = ~0, // All submodules selected to log
    .appLogIndex = -1,
    .nvsLogIndex = -1,
    .mqttLogIndex = -1,
    .gnssLogIndex = -1,
...
/* sends location data to bluetooth connected device */
            ...
            case APP_FSM_RUN:
                ...
                if ((app.error == APP_ERROR_OK) && (gnssState == XPLR_GNSS_STATE_DEVICE_READY)) {
                    ...
                    if (app.error != APP_ERROR_OK) {
                        ...
                        appSendLocationToBt(APP_BT_LOCATION_INTERVAL);
#if 1 == APP_PRINT_IMU_DATA
                        /* Print location data every APP_GNSS_INTERVAL sec */
