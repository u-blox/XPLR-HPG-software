...
9. Go to `XPLR HPG Options -> Wi-Fi Settings` and input the **SSID** and **password** of your access-point.
...
**`CONFIG_XPLR_WIFI_NTRIP_HOST`** | "host" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | NTRIP caster URL/IP address
**`CONFIG_XPLR_WIFI_NTRIP_PORT`** | "2101" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | NTRIP caster port
**`CONFIG_XPLR_WIFI_NTRIP_MOUNTPOINT`** | "mountpoint" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | NTRIP caster mountpoint
**`CONFIG_XPLR_WIFI_NTRIP_USERAGENT`** | "NTRIP_XPLR_HPG" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | User-Agent
**`CONFIG_XPLR_WIFI_NTRIP_USE_AUTH`** | "True" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | Use authentication
**`CONFIG_XPLR_WIFI_NTRIP_USERNAME`** | "username" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | Username
**`CONFIG_XPLR_WIFI_NTRIP_PASSWORD`** | "password" | **[hpg_wifi_ntrip_correction](./main/hpg_wifi_ntrip_correction.c)** | Password
<br>
